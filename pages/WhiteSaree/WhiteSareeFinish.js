...
export default function WhiteSareeFinish({ navigation, orderData }) {
  return (
      ...
      <View style={styles.content}>
        <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
          <View style={styles.processDetails}>
            <Text style={styles.sectionTitle}>FINISH Process</Text>
            ...
            <View style={styles.processInfo}>
              <Text style={styles.sectionTitle}>FINISH Process Details</Text>
              <Text style={styles.processDescription}>
                This is the FINISH process page for White Saree. Here you can manage the finishing process including final fabric treatment, quality control, and preparation for delivery for white saree production.
              </Text>
            </View>
          </View>
        </ScrollView>
