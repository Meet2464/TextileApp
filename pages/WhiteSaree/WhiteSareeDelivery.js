...
export default function WhiteSareeDelivery({ navigation, orderData }) {
  return (
        ...
        <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
          <View style={styles.processDetails}>
            ...
            <View style={styles.processInfo}>
              <Text style={styles.sectionTitle}>DELIVERY Process Details</Text>
              <Text style={styles.processDescription}>
                This is the DELIVERY process page for White Saree. Here you can manage the final delivery process including packaging, dispatch preparation, and shipment tracking for white saree production.
              </Text>
            </View>
          </View>
        </ScrollView>
