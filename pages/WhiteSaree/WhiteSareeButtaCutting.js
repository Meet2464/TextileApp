...
export default function WhiteSareeButtaCutting({ navigation, orderData }) {
  return (
      ...
      <View style={styles.content}>
        <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
          <View style={styles.processDetails}>
            <Text style={styles.sectionTitle}>BUTTA CUTTING Process</Text>
            ...
            <View style={styles.processInfo}>
              <Text style={styles.sectionTitle}>BUTTA CUTTING Process Details</Text>
              <Text style={styles.processDescription}>
                This is the BUTTA CUTTING process page for White Saree. Here you can manage the butta cutting process including pattern cutting, fabric preparation, and precision cutting operations for white saree production.
              </Text>
            </View>
          </View>
        </ScrollView>
