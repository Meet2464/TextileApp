...
export default function WhiteSareeJecard({ navigation, orderData }) {
  return (
          ...
          <View style={styles.processDetails}>
            ...
            <View style={styles.processInfo}>
              ...
              <Text style={styles.processDescription}>
                This is the JECARD process page for White Saree. Here you can manage the jecard production process including pattern creation, design implementation, and quality control for white saree production.
              </Text>
            </View>
          </View>
        </ScrollView>
