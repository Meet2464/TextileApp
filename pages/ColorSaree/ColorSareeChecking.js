...
export default function ColorSareeChecking({ navigation, orderData }) {
  return (
      ...
      <View style={styles.content}>
        <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
          <View style={styles.processDetails}>
            <Text style={styles.sectionTitle}>CHECKING Process</Text>
            ...
            <View style={styles.processInfo}>
              <Text style={styles.sectionTitle}>CHECKING Process Details</Text>
              <Text style={styles.processDescription}>
                This is the CHECKING process page for Color Saree. Here you can manage the quality checking process including defect inspection, quality control, and final approval before delivery.
              </Text>
            </View>
          </View>
        </ScrollView>
