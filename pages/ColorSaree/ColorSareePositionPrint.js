      ...
      <View style={styles.content}>
        <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
          <View style={styles.processDetails}>
            <Text style={styles.sectionTitle}>POSITION PRINT Process</Text>
            ...
            <View style={styles.processInfo}>
              <Text style={styles.sectionTitle}>POSITION PRINT Process Details</Text>
              <Text style={styles.processDescription}>
                This is the POSITION PRINT process page for Color Saree. Here you can manage the position printing process including precise design placement, color application, and print quality control.
              </Text>
            </View>
          </View>
        </ScrollView>
