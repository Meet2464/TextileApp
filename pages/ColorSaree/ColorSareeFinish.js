...
export default function ColorSareeFinish({ navigation, orderData }) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerInfo}>
          <Text style={styles.headerTitle}>Color Saree - FINISH</Text>
          {orderData && (
          ...
          <View style={styles.processDetails}>
            ...
            <View style={styles.processInfo}>
              ...
              <Text style={styles.processDescription}>
                This is the FINISH process page for Color Saree. Here you can manage the finishing process including final fabric treatment, quality control, and preparation for delivery.
              </Text>
            </View>
          </View>
        </ScrollView>
