      ...
      <View style={styles.content}>
        <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
          <View style={styles.processDetails}>
            <Text style={styles.sectionTitle}>COTTING Process</Text>
            ...
            <View style={styles.processInfo}>
              <Text style={styles.sectionTitle}>COTTING Process Details</Text>
              <Text style={styles.processDescription}>
                This is the COTTING process page for Color Saree. Here you can manage the cotting process including protective coating application, fabric treatment, and quality control.
              </Text>
            </View>
          </View>
        </ScrollView>
