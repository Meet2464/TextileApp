...
export default function ColorSareeButtaCutting({ navigation, orderData }) {
  return (
          ...
          <View style={styles.processDetails}>
            ...
            <View style={styles.processInfo}>
              ...
              <Text style={styles.processDescription}>
                This is the BUTTA CUTTING process page for Color Saree. Here you can manage the butta cutting process including pattern cutting, fabric preparation, and precision cutting operations.
              </Text>
            </View>
          </View>
        </ScrollView>
