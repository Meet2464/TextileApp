...
export default function ColorSareeBleach({ navigation, orderData }) {
  return (
          ...
          <View style={styles.processDetails}>
            ...
            <View style={styles.processInfo}>
              ...
              <Text style={styles.processDescription}>
                This is the BLEACH process page for Color Saree. Here you can manage the bleaching process including chemical treatment, color removal, and fabric preparation.
              </Text>
            </View>
          </View>
        </ScrollView>
