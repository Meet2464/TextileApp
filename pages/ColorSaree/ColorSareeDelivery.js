...
export default function ColorSareeDelivery({ navigation, orderData }) {
  return (
          ...
          <View style={styles.processDetails}>
            ...
            <View style={styles.processInfo}>
              ...
              <Text style={styles.processDescription}>
                This is the DELIVERY process page for Color Saree. Here you can manage the final delivery process including packaging, dispatch preparation, and shipment tracking.
              </Text>
            </View>
          </View>
        </ScrollView>
